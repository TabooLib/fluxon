...
public class Expressions {
    ...
    public static class UnaryExpression implements Expression {
        ...
        @Override
        public String toString() {
            return "Unary(" + operator.getStringValue() + ", " + right + ")";
        }

        @Override
        public String toPseudoCode() {
            return operator.getStringValue() + right.toPseudoCode();
        }
    }
    ...
    public static class BinaryExpression implements Expression {
        ...
        @Override
        public String toString() {
            return "Binary(" + left + ", " + operator.getStringValue() + ", " + right + ")";
        }

        @Override
        public String toPseudoCode() {
            return left.toPseudoCode() + " " + operator.getStringValue() + " " + right.toPseudoCode();
        }
    }
    ...
    public static class LogicalExpression implements Expression {
        ...
        @Override
        public String toString() {
            return "Logical(" + left + ", " + operator.getStringValue() + ", " + right + ")";
        }
    ...
    public static class Assignment implements Expression {
        ...
        @Override
        public String toString() {
            return "Assignment(" + name + ", " + operator.getStringValue() + ", " + value + ")";
        }

        @Override
        public String toPseudoCode() {
            return name + " " + operator.getStringValue() + " " + value.toPseudoCode();
        }
    }
