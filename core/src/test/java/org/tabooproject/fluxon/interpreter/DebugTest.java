...
public class DebugTest {
    ...
    public void testFunctionMul() {
        ...
        System.out.println("Function: twice(6) Interpret result: " + result.getInterpretResult());
        System.out.println("Function: twice(6) Compile result: " + result.getCompileResult());
        assertEquals(12, result.getInterpretResult());
        assertEquals(12, result.getCompileResult());
    }
}
