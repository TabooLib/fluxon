...
public class FunctionMath {
    ...
    public static void init(FluxonRuntime runtime) {
        ...
        runtime.registerFunction("sin", 1, args -> Math.sin(validateAndGetNumber(args[0]).doubleValue()));
        runtime.registerFunction("cos", 1, args -> Math.cos(validateAndGetNumber(args[0]).doubleValue()));
        runtime.registerFunction("tan", 1, args -> Math.tan(validateAndGetNumber(args[0]).doubleValue()));
        ...
        runtime.registerFunction("atan", 1, args -> Math.atan(validateAndGetNumber(args[0]).doubleValue()));
        runtime.registerFunction("exp", 1, args -> Math.exp(validateAndGetNumber(args[0]).doubleValue()));
