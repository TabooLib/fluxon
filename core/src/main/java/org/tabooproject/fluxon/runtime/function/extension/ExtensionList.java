...
public class ExtensionList {
    ...
    public static void init(FluxonRuntime runtime) {
        // 添加元素
        runtime.registerExtensionFunction(List.class, "add", 1, (context) -> Objects.requireNonNull(context.getTarget()).add(context.getArguments()[0]));
        // 获取列表大小
        runtime.registerExtensionFunction(List.class, "size", 0, (context) -> Objects.requireNonNull(context.getTarget()).size());
        // 获取指定索引的元素
